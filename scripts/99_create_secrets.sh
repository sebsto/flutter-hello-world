...
aws --region $REGION secretsmanager create-secret --name $MOBILE_PROVISIONING_PROFILE_DIST_SECRET --secret-binary fileb://./secrets/flutterhelloworld-dist.mobileprovision
